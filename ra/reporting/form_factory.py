...
class RaReportBaseForm(object):
    ...
    # start_date = forms.DateTimeField(required=True, label=_('From date'))
    # end_date = forms.DateTimeField(required=True, label=_('To  date'))
...
def report_form_factory(model, fkeys_filter_func=None, foreign_key_widget_func=None, **kwargs):
    ...
    # fields.update({"base_fields": fields,
    #                '_fkeys': fkeys_list,
...
# def report_form_factory2(model, base_model=None,
