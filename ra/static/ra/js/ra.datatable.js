...
(function ($) {
    ...
    function buildAndInitializeDataTable(data, $elem, extraOptions, successFunction) {
        ...
        let isGroup = true;
        let opts = $.extend({}, $.ra.datatable.defaults, extraOptions);
        ...
        datatable_container.html(constructTable(datatable_slug,
            $.ra.datatable.defaults.tableCssClass, data['columns'], column_names,
...
$.ra.datatable.defaults = {

    enableFixedHeader: false,
    fixedHeaderZindex: 2001,
    messages: {
        total: $.ra.defaults.messages.total,
    },
