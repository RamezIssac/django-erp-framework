    ...
    DateRangePicker.prototype = {
        ...
        move: function() {
            ...
            if (this.opens == 'left') {
                ...
                // changed because of incorrect left computing in rtl making the calendar look ugly
                // left_px
                var left_px =this.element.offset().left - parentOffset.left;
                this.container.css({
                    top: containerTop,
                    left: left_px,
                    right: 'auto'
                });
                // Ramez hack here append -30
                if (left_px + this.container.outerWidth() > $(window).width() - 30) {
                    this.container.css({
                        left: 'auto',
                        right: 0
                    });
