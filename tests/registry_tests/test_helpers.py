...
class TestChecks(TestCase):
    ...
    @override_settings(INSTALLED_APPS=[x for x in settings.INSTALLED_APPS if x != 'crequest'],
                       MIDDLEWARE=[x for x in settings.MIDDLEWARE if x != 'crequest.middleware.CrequestMiddleware'])
