#!/usr/bin/env python
"""
Completely a ripoff of Wagtail start command
"""
import os
import sys
...
if CURRENT_PYTHON < REQUIRED_PYTHON:
    sys.stderr.write(
        "This version of Ra requires Python {}.{} or above - you are running {}.{}\n".format(
...
class CreateProject(Command):
    description = "Creates the directory structure for a new Ra project."

    def add_arguments(self, parser):
        parser.add_argument("project_name", help="Name for your Ra project")
        parser.add_argument(
            "dest_dir",
            nargs="?",
    ...
    def run(self, project_name=None, dest_dir=None):
        ...
        print(
            "Creating a Ra project called %(project_name)s"
        ...
        ra_path = os.path.dirname(erp_framework.__file__)
