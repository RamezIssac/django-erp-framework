...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Report',
            fields=[
                ('code', models.CharField(editable=False, max_length=255, primary_key=True, serialize=False, verbose_name='Code')),
                ('deleted', models.BooleanField(default=False, verbose_name='deleted')),
                ('groups', models.ManyToManyField(through='reporting.GroupReportPermission', to='auth.group', verbose_name='Groups')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('export', models.BooleanField(default=True, verbose_name='Export')),
                ('deleted', models.BooleanField(default=False, verbose_name='deleted')),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporting.report', verbose_name='Report')),
        ...
        migrations.AddField(
            model_name='report',
            name='users',
            field=models.ManyToManyField(through='reporting.UserReportPermission', to=settings.AUTH_USER_MODEL, verbose_name='Users'),
        ),
        migrations.AddField(
            model_name='groupreportpermission',
            name='report',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporting.report', verbose_name='Report'),
        ),
    ]
